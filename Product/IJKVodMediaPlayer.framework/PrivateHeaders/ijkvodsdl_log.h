...
#ifndef ijkvodsdl_log_h
#define ijkvodsdl_log_h
...
//#define VLOG(...) VODVLOG(__VA_ARGS__)
//#define ALOG(...) VODALOG(__VA_ARGS__)

#define VLOGV(...)  VODVLOGV(__VA_ARGS__)
#define VLOGD(...)  VODVLOGD(__VA_ARGS__)
#define VLOGI(...)  VODVLOGI(__VA_ARGS__)
#define VLOGW(...)  VODVLOGW(__VA_ARGS__)
#define VLOGE(...)  VODVLOGE(__VA_ARGS__)

#define ALOGV(...)  VODALOGV(__VA_ARGS__)
#define ALOGD(...)  VODALOGD(__VA_ARGS__)
#define ALOGI(...)  VODALOGI(__VA_ARGS__)
#define ALOGW(...)  VODALOGW(__VA_ARGS__)
#define ALOGE(...)  VODALOGE(__VA_ARGS__)
